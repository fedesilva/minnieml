...
- Phase 3 — Closures: capturing lambdas + ownership
  ...
  - [ ] 3.4-QA — Codegen & ownership review fixes (spec: `context/specs/lambdas-work-review.md`)
    ...
    - [ ] 3.4-QA.6 [P2] Pass real closure env on recursive capturing lambdas (`Applications.scala`)
    - [ ] 3.4-QA.7 [P2] Keep capture support in tail-recursive lambda path (`ExpressionCompiler.scala`)
    - [ ] 3.4-QA.8 [P2] Stop freeing non-capturing function values as closures (`OwnershipAnalyzer.scala`)
