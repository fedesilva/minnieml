...
Superseded ownership proposal. Current language and ownership references are
[the language reference](../../docs/language-reference.md) and
[the memory model](../../docs/memory-model.md). Its call-site move proposal and examples
do not define current syntax.

Archived from `context/specs/optional-moves.md` on 2026-09-10 for Author review.
