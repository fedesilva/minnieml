# Add runtime cache management commands
...
Add commands to manage the cache: `init` and `clean`.

## Outcome

Users can initialize and clean the runtime cache through explicit commands.
