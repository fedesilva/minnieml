...
- **External Reference (optional):** https://github.com/fedesilva/minnieml/issues/238

## Problem

Core definitions are synthesized in Scala instead of ingested from the MML prelude.

## Outcome

Ingest the prelude while preserving symbol identity, native binding, and ownership behavior.

## Scope

The retained design below defines the proposed scope; implementation requires a bounded plan.

### Retained prelude design

Draft with recorded Author answers. Implementation inventories and numeric counts
are source-era investigation notes, not a fresh audit.
