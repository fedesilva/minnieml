...
See the [duplicate-capture report](#duplicate-capture-report) below.
...
Investigate the reported IR failure and agree on a correction grounded in the actual compiler phases.
...
### Duplicate-capture report

Preserved report and reproduction. Its proposed correction is subject to review
against the actual compiler phases; it does not establish harmless ownership behavior.
...
The report is retained in this task’s Scope section.
